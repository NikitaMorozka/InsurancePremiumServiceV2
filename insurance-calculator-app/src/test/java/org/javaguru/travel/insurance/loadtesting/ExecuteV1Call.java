...
public class ExecuteV1Call extends ExecuteRestCallAndCompareResults implements Runnable {
    ...
    ExecuteV1Call(LoadTestingStatistic loadTestingStatistic) {
        this.loadTestingStatistic = loadTestingStatistic;
    }

    public void run() {
        String jsonRequest = jsonFileReader.readJsonFromFile("rest/restV1/request.json");
        String jsonResponse = jsonFileReader.readJsonFromFile("rest/restV1/response.json");
